...
- 내부 슬롯과 내부 메서드는 자바스크립트 엔진의 구현 알고리즘을 설명하기 위해 ECMAScript 사양에서 사용하는 의사 프로퍼티(pseudo property)와 (pseudo method)다.
...
| 객체 밀봉 | Object.seal | undefined | X | X | O | O | X |
| 객체 동결 | Object.freeze | undefined | X | X | O | X | X |
